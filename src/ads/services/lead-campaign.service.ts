...
export class LeadCampaignService {
  ...
  async create(workspaceId: string, userId: string, dto: CreateLeadCampaignDto) {
    ...
    // 5) Creative
    const creative = await this.meta.createCreativeLead(acct.metaAdAccountId, userToken, {
