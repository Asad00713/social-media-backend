...
export const dripCampaigns = pgTable('drip_campaigns', {
  ...
  aiGenerationLeadTime: integer('ai_generation_lead_time')
    .default(60)
    .notNull(), // 60 minutes = 1 hour
  emailNotificationLeadTime: integer('email_notification_lead_time')
    .default(30)
    .notNull(), // 30 minutes
...
export const dripCampaignHistory = pgTable('drip_campaign_history', {
  ...
  dripCampaignId: uuid('drip_campaign_id')
    .notNull()
    .references(() => dripCampaigns.id, { onDelete: 'cascade' }),
  dripPostId: uuid('drip_post_id').references(() => dripPosts.id, {
    onDelete: 'set null',
  }),
...
export const dripCampaignHistoryRelations = relations(
  dripCampaignHistory,
  ({ one }) => ({
    dripCampaign: one(dripCampaigns, {
...
export type NewDripCampaignHistoryEntry =
  typeof dripCampaignHistory.$inferInsert;
